...
# prepare data path
user_data_path = '../data/user_pre_encoded_sorted' # item embeddings generated by item reviews
rel_path = '../data/user_rel_train'  # relevance samples of users (used for relevance learning objective and are generated from user sequences)
unp_path = '../data/user_unexpectedness_samples'  # unexpectedness samples of users (used for unexpectedness learning objective and are generated by Unexpectedness_generation.py)
sre_path = '../data/user_pre_candidate' # serendipity samples (ground truth for serendipity learning objective and are obtained from SerenLens)
test_path = '../data/user_pre_test'  # test set (rest 20% of data)
